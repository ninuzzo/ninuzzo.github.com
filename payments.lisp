...
")
    ...
    (section :class "newline"
     ...
     (p "That is to pay directly in my Italian bank account. If you opt to pay this way you will first need to ask me my bank account number. I haven't published it here because I want people to be aware of bank fees "
      (em "before")
      " they pay money into my account — they usually apply both to me and you and in some cases can greatly reduce the sum I get.")
     (dl
      (dt "if you live in an European country using the euro or the Swedish crown (SEK), excluding the UK")
      (dd
      ...
      (dt "if you live outside Europe or in the UK, namely your local currency is neither euros nor SEK")
      (dd
       (p "In this case my bank charges me € 7.5 + mininum between € 1.5 and 0.15% of the amount received. Your bank will also charge similarly or even more to send the money. We would probably be both better off if you "
