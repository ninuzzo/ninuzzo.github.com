...
[
 ...
 ['def', "who", "wer", "chi", "In Italian 'ci' is always pronounced like chee- in cheese (but the i is short) and it means 'to us' or 'there', depending on the context. 'Chi' is pronounced like 'key', but again with a short vowel sound. The h is silent, but it changes the word pronunciation and differentiates these two words different in writing."],
